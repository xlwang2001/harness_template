...
This file is the map, not the manual.
...
- Update docs when durable project knowledge changes.
- Run the relevant validation commands before handoff.
- Leave a concise review packet with tests, risks, and follow-ups.
